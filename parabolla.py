...
def plot_data_with_cubic_approximation():
    csv_file = 'data.csv'
    h_values = []
    avg_values = []
    ...
    avg_approx = cubic_func(h_approx, *popt)
    ...
    # Построение аппроксимированной кривой (кубическая функция)
    plt.plot(h_approx, avg_approx, label=f'Кубическая аппроксимация (a={a:.4f}, b={b:.4f}, c={c:.4f}, d={d:.4f})', color='green')
...
def main():
    plot_data_with_cubic_approximation()
